...
l17_index = [
    i for i in range(len(sr_m03p01l17[:, 0])) if -60 <= sr_m03p01l17[i, 0] <= -50
]
l22_index = [
    i for i in range(len(sr_m03p01l22[:, 0])) if -60 <= sr_m03p01l22[i, 0] <= -50
]
l27_index = [
    i for i in range(len(sr_m03p01l27[:, 0])) if -60 <= sr_m03p01l27[i, 0] <= -50
]
