...
plt.xscale("log")
plt.yscale("log")
plt.plot(a_X, rho_L_norm, label=r"$ \rho_{\Lambda,0} $")
plt.plot(a_X, rho_m_norm, label=r"$ \rho_{m,0} $")
plt.plot(a_X, rho_k_norm_abs, label=r"$ \rho_{k,0} $ ($ k = -1 $)")
plt.plot(a_X, rho_r_norm, label=r"$ \rho_{r,0} $")
plt.xlim(1e-5, 10)
plt.xlabel(r"$ \bar{a} $")
