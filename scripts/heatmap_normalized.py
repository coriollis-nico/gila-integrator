...
data_l17_mp_pivot = data_l17_mp.pivot(index="p", columns="m", values="d")

data_l27_mp = data_l27.loc[:, ("m", "p", "d")]
data_l27_mp_pivot = data_l27_mp.pivot(index="p", columns="m", values="d")

data_l22_mp = data_l22.loc[:, ("m", "p", "d")]
data_l22_mp_pivot = data_l22_mp.pivot(index="p", columns="m", values="d")
...
fig, axs = plt.subplots(
    1, 3, layout="constrained", squeeze=True, sharey=True, sharex=True
)
